...
namespace ImGui
{
    ...
    internal class Window
    {
        ...
        public Window(string name, Point position, Size size, WindowFlags Flags)
        {
            ...
            //create and initialize render tree
            this.RenderTree = new RenderTree(this.ID, this.Position, this.ClientRect.Size);
            this.RenderTree.Root.Rect = ClientRect;

            //title bar node
            {
                var id = this.GetID("TitleBar");//TODO We should not use id generated by name and use a id generator instead.
            ...
            long currentFrame, Window parentWindow)
        {
            ...
            {
                this.Position = position;
                this.FullSize = size; // 'size' provided by user passed via BeginChild()->Begin().
            }
        ...
        public void ApplySize(Size new_size)
        {
            ...
            this.RenderTree.Root.Rect = this.ClientRect;
        }
